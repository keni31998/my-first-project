...
多公司财务交互分析系统
Created by ConnieACC102 Mini Assignment - Track 4 (Interactive Tool)
...
Annual Revenue Comparison (grouped bar chart)
Annual Net Profit Trend
Revenue Share Pie Chart
Profit Contribution Bar Chart
Revenue Growth Rate Trend
Net Profit Margin Ranking
Asset Scale Comparison
Comprehensive Capability Radar Chart + Score Table
年度营收对比（分组柱状图）
年度净利润趋势
营收占比饼图
利润贡献度条形图
